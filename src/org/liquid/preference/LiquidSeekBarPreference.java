 ...
 * @hide
 */
public class LiquidSeekBarPreference extends Preference
    ...
    public LiquidSeekBarPreference(Context context, AttributeSet attrs) {
        super(context, attrs);

        try {
            mContext = getContext().createPackageContext("org.liquid.framework", 0);
