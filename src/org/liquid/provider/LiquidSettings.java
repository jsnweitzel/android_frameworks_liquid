...
public final class LiquidSettings {
    ...
    public static final String AUTHORITY = "liquidsettings";

    public static class LiquidSettingNotFoundException extends AndroidException {
        public LiquidSettingNotFoundException(String msg) {
            super(msg);
        }
    }
    ...
    public static final class System extends Settings.NameValueTable
            implements LiquidSettingsKeys.System {
        public static final String SYS_PROP_LIQUID_SETTING_VERSION
                = "sys.liquid_setting_system_version";
        ...
        private static final NameValueCache sNameValueCache = new NameValueCache(
                SYS_PROP_LIQUID_SETTING_VERSION,
                CONTENT_URI,
         ...
         * it throws {@link LiquidSettingNotFoundException}.
         *
         * @param cr The ContentResolver to access.
         * @param name The name of the setting to retrieve.
         *
         * @throws LiquidSettingNotFoundException Thrown if a setting by the given
         * name can't be found or the setting value is not an integer.
         *
         * @return The setting's current value.
         */
        public static int getInt(ContentResolver cr, String name)
                throws LiquidSettingNotFoundException {
        ...
        public static int getIntForUser(ContentResolver cr, String name, int userHandle)
            ...
            try {
                ...
                throw new LiquidSettingNotFoundException(name);
            }
        }
    ...
    public static final class Secure extends Settings.NameValueTable
            implements LiquidSettingsKeys.Secure {
        public static final String SYS_PROP_LIQUID_SETTING_VERSION
                = "sys.liquid_settings_secure_version";
    ...
    public static final class Global extends Settings.NameValueTable
            implements LiquidSettingsKeys.Global {
        public static final String SYS_PROP_LIQUID_SETTING_VERSION
                = "sys.liquid_settings_global_version";
