...
import org.liquid.utils.ConfigSplitHelper;
import org.liquid.utils.DeviceUtils;
import org.liquid.utils.DeviceUtils.FilteredDeviceFeaturesArray;
import org.liquid.utils.ImageHelper;

public class ActionHelper {

    private static final String SYSTEM_METADATA_NAME = "android";
    private static final String LIQUID_FRAMEWORK_METADATA_NAME = "org.liquid.framework";
    ...
    private static String getNavBarProvider(Context context) {
        String config = LiquidSettings.System.getStringForUser(
                    context.getContentResolver(),
                    LiquidSettings.System.NAVIGATION_BAR_CONFIG,
    ...
    public static void setNavBarConfig(Context context,
        ...
        LiquidSettings.System.putString(context.getContentResolver(),
                    LiquidSettings.System.NAVIGATION_BAR_CONFIG,
                    config);
    }
    ...
    public static Drawable getActionIconImage(Context context,
        ...
        Resources resources;
        try {
            resources = pm.getResourcesForApplication(LIQUID_FRAMEWORK_METADATA_NAME);
        } catch (Exception e) {
        ...
        if (!clickAction.startsWith("**")) {
            try {
                ...
                resId = resources.getIdentifier(
                    LIQUID_FRAMEWORK_METADATA_NAME + ":drawable/ic_sysbar_null", null, null);
                if (resId > 0) {
    ...
    private static int getActionSystemIcon(Resources resources, String clickAction) {
        ...
        if (clickAction.equals(ActionConstants.ACTION_HOME)) {
            resId = resources.getIdentifier(
                        LIQUID_FRAMEWORK_METADATA_NAME + ":drawable/ic_sysbar_home", null, null);
        } else if (clickAction.equals(ActionConstants.ACTION_BACK)) {
            resId = resources.getIdentifier(
                        LIQUID_FRAMEWORK_METADATA_NAME + ":drawable/ic_sysbar_back", null, null);
        } else if (clickAction.equals(ActionConstants.ACTION_RECENTS)) {
            resId = resources.getIdentifier(
                        LIQUID_FRAMEWORK_METADATA_NAME + ":drawable/ic_sysbar_recent", null, null);
            ...
            resId = resources.getIdentifier(
                        LIQUID_FRAMEWORK_METADATA_NAME + ":drawable/ic_sysbar_search", null, null);
        } else if (clickAction.equals(ActionConstants.ACTION_MENU)) {
            resId = resources.getIdentifier(
                        LIQUID_FRAMEWORK_METADATA_NAME + ":drawable/ic_sysbar_menu", null, null);
        } else if (clickAction.equals(ActionConstants.ACTION_MENU_BIG)) {
            resId = resources.getIdentifier(
                        LIQUID_FRAMEWORK_METADATA_NAME + ":drawable/ic_sysbar_menu_big", null, null);
        } else if (clickAction.equals(ActionConstants.ACTION_IME)) {
            resId = resources.getIdentifier(
                        LIQUID_FRAMEWORK_METADATA_NAME + ":drawable/ic_sysbar_ime_switcher", null, null);
        } else if (clickAction.equals(ActionConstants.ACTION_POWER)) {
            resId = resources.getIdentifier(
                        LIQUID_FRAMEWORK_METADATA_NAME + ":drawable/ic_sysbar_power", null, null);
        } else if (clickAction.equals(ActionConstants.ACTION_POWER_MENU)) {
            resId = resources.getIdentifier(
                        LIQUID_FRAMEWORK_METADATA_NAME + ":drawable/ic_sysbar_power_menu", null, null);
        } else if (clickAction.equals(ActionConstants.ACTION_VIB)) {
            resId = resources.getIdentifier(
                        LIQUID_FRAMEWORK_METADATA_NAME + ":drawable/ic_sysbar_vib", null, null);
        } else if (clickAction.equals(ActionConstants.ACTION_SILENT)) {
            resId = resources.getIdentifier(
                        LIQUID_FRAMEWORK_METADATA_NAME + ":drawable/ic_sysbar_silent", null, null);
        } else if (clickAction.equals(ActionConstants.ACTION_VIB_SILENT)) {
            resId = resources.getIdentifier(
                        LIQUID_FRAMEWORK_METADATA_NAME + ":drawable/ic_sysbar_ring_vib_silent", null, null);
        } else if (clickAction.equals(ActionConstants.ACTION_EXPANDED_DESKTOP)) {
            resId = resources.getIdentifier(
                        LIQUID_FRAMEWORK_METADATA_NAME + ":drawable/ic_sysbar_expanded_desktop", null, null);
        } else if (clickAction.equals(ActionConstants.ACTION_KILL)) {
            resId = resources.getIdentifier(
                        LIQUID_FRAMEWORK_METADATA_NAME + ":drawable/ic_sysbar_killtask", null, null);
        } else if (clickAction.equals(ActionConstants.ACTION_LAST_APP)) {
            resId = resources.getIdentifier(
                        LIQUID_FRAMEWORK_METADATA_NAME + ":drawable/ic_sysbar_lastapp", null, null);
        } else if (clickAction.equals(ActionConstants.ACTION_NOTIFICATIONS)) {
            resId = resources.getIdentifier(
                        LIQUID_FRAMEWORK_METADATA_NAME + ":drawable/ic_sysbar_notifications", null, null);
        } else if (clickAction.equals(ActionConstants.ACTION_SETTINGS_PANEL)) {
            resId = resources.getIdentifier(
                        LIQUID_FRAMEWORK_METADATA_NAME + ":drawable/ic_sysbar_qs", null, null);
        } else if (clickAction.equals(ActionConstants.ACTION_SCREENSHOT)) {
            resId = resources.getIdentifier(
                        LIQUID_FRAMEWORK_METADATA_NAME + ":drawable/ic_sysbar_screenshot", null, null);
        } else if (clickAction.equals(ActionConstants.ACTION_TORCH)) {
            resId = resources.getIdentifier(
                        LIQUID_FRAMEWORK_METADATA_NAME + ":drawable/ic_sysbar_torch", null, null);
        } else if (clickAction.equals(ActionConstants.ACTION_CAMERA)) {
            resId = resources.getIdentifier(
                        LIQUID_FRAMEWORK_METADATA_NAME + ":drawable/ic_sysbar_camera", null, null);
        ...
        if (d != null) {
            ...
            d = ImageHelper.getColoredDrawable(d, 
                    context.getResources().getColor(
                            org.liquid.framework.internal.R.color.dslv_icon_dark));
        }
        return d;
    }
    ...
    public static String getActionDescription(Context context, String action) {
        ...
        FilteredDeviceFeaturesArray actionsArray
                ...
                resources.getStringArray(
                        resources.getIdentifier(LIQUID_FRAMEWORK_METADATA_NAME
    ...
    private static Resources getResources(Context context) {
        try {
            return context.getPackageManager()
                    .getResourcesForApplication(LIQUID_FRAMEWORK_METADATA_NAME);
        } catch (Exception e) {
            return null;
        }
    }
